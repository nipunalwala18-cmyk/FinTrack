        ...
        <form onSubmit={handleSubmit(onSubmit, onError)} className="flex flex-col flex-grow overflow-hidden">
          ...
          >
            <div className="space-y-1 text-left">
              ...
              <p className="text-sm font-semibold text-white/50">Record a new income, expense, or account transfer.</p>
            </div>
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="grid gap-6 grid-cols-1 md:grid-cols-2 text-left">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.date && <p className="text-xs font-semibold" style={{ color: 'rgba(248,113,113,0.9)' }}>{errors.date.message}</p>}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.description && <p className="text-xs font-semibold" style={{ color: 'rgba(248,113,113,0.9)' }}>{errors.description.message}</p>}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.notes && <p className="text-xs font-semibold" style={{ color: 'rgba(248,113,113,0.9)' }}>{errors.notes.message}</p>}
                </div>
